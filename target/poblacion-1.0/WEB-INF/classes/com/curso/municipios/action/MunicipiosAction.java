...
public class MunicipiosAction extends SuperAction{
	...
	private MunicipioServiceImpl municipios;
	...
	public MunicipioServiceImpl getMunicipios() {
		return municipios;
	}

	public void setMunicipios(MunicipioServiceImpl municipios) {
	...
	public String execute(){
		...
		secciones=Combodao.getSecciones();
		grupos=Combodao.getGrupos();
		return SUCCESS;
	}
	
public CombosDao getCombodao() {
		return Combodao;
	}

	public void setCombodao(CombosDao combodao) {
		Combodao = combodao;
	}

public String buscar(){
		
	municipios= new MunicipioServiceImpl();
	...
	try {
		...
		List<MunicipioVO> lista = municipios.getMunicipios(clavestado); 
...
public String guarda(){
	...
	}else if(StringUtils.isBlank(municipio.getClave())){
		success=false;
