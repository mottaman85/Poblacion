...
<script type="text/javascript" src="${ctx}/js/constantes-en.js"></script>
<script type="text/javascript" src="${ctx}/js/core/jquery.mobile-1.4.2/jquery.mobile-1.4.2.min.js"></script>
