...
<fieldset style="border: 1px solid #BDBDBD; margin: 10px 10px 10px 0px; width: 70%;">
   <legend align="left">Busqueda</legend>
<form action="" id="buscaRol">
 <label for="cve">Clave</label> <input type="text" name="rol.cve_rol" id="cveBusca">
 
 <label for="estatus">Estatus</label> 
 <select name="rol.st_rol" id="estatusBusca">
 	<option value="A">Activo</option>
 	<option value="I">Inctivo</option>
 </select>
</form>
 <input type="button" id="buscaBtn">
 </fieldset>
